      ...
      <section className="py-28">
        <div className="w-full max-w-[1296px] m-auto px-6 flex flex-col lg:flex-row items-start gap-24 justify-between">
          ...
          <div className="flex flex-col gap-8 w-full lg:max-w-[566px]">
            <div>
              <h2 className="text-[28px] lg:text-[32px] font-medium">Documentos necessários</h2>
            </div>
            <AllProgress firstProcess="concluded" secondProcess="concluded" thirdProcess="inProgress" />
            <Form />
          </div>
        </div>
      </section>
